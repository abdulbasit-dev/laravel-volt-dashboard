...
@section('content')
  ...
  <div class="d-flex justify-content-between flex-md-nowrap align-items-center flex-wrap py-4">
    ...
    <div class="btn-toolbar mb-md-0 mb-2">
      <a href="{{ route('subscribers.index') }}" class="btn btn-sm btn-warning d-inline-flex align-items-center">
              ...
              <div class="col-lg-7 col-sm-6">
                <fieldset class="mt-3">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('nid') is-invalid @enderror" id="nid" name="nid" value="{{ old('nid') }}">
                    @error('nid')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="mb-4">
                    ...
                    <input type="tel" class="form-control" id="phone_number_alt" name="phone_number_alt" value="{{ old('phone_number_alt') }}">
                  </div>
                  <!-- End of Form -->
                  ...
                  <div class="mb-3">
                    <label for="image" class="form-label">Image</label>
                    <input type="file" id="image" name="filepond" class="filepond" accept="image/png, image/jpeg, image/gif">
                  </div>
                  <!-- End of Form --> --}}
              ...
              <div class="col-lg-7 col-sm-6">
                <fieldset class="mt-3">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('area') is-invalid @enderror" id="property_number" name="property_number" value="{{ old('property_number') }}">
                  ...
                  <div class="mb-4">
                    ...
                    <select class="form-select @error('city') is-invalid @enderror" id="city" name="city">
                      ...
                      @foreach ($cities as $key => $value)
                        <option value="{{ $value }}" @selected($value == old('city'))>
                          {{ $value }}</option>
                      @endforeach
                    </select>
                    @error('city')
                  ...
                  <div class="mb-4">
                    ...
                    <select class="form-select @error('zone') is-invalid @enderror" id="zone" name="zone">
                      ...
                      @foreach ($zones as $key => $value)
                        <option value="{{ $key }}" @selected($key == old('zone'))>{{ $value }}</option>
                      @endforeach
                    </select>
                    @error('zone')
                      <div class="invalid-feedback">{{ $message }}</div>
                ...
                <fieldset>
                  ...
                  <div class="mb-4">
                    ...
                    <input type="number" class="form-control @error('ampere') is-invalid @enderror" min="2" max="40" id="ampere" name="ampere" value="{{ old('ampere') }}">
                    @error('ampere')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_active" id="exampleRadios2" value="0" @checked(old('is_active'))>
                    <label class="form-check-label" for="exampleRadios2">
                      InActive
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_active" id="exampleRadios1" value="1" @checked(old('is_active'))>
...
@push('scripts')
  <script>
    ...
    FilePond.create(
      document.querySelector('input#image1'), {
